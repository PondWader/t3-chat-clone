...
export default function Llama(props: { height: number; width: number }) {
    ...
    return (
        ...
        >
            <defs>
                ...
                <linearGradient
                    id={`lobe-icons-meta-fill-10_${id}`}
                    x1="20.433%"
                    x2="82.112%"
                    y1="50.001%"
                    y2="50.001%"
                ...
                <linearGradient
                    id={`lobe-icons-meta-fill-11_${id}`}
                    x1="40.303%"
                    x2="72.394%"
                    y1="35.298%"
                    y2="57.811%"
                ...
                <linearGradient
                    id={`lobe-icons-meta-fill-12_${id}`}
                    x1="32.254%"
                    x2="68.003%"
                    y1="19.719%"
                    y2="84.908%"
            ...
            <g fill="none" fill-rule="nonzero">
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-0_${id})`}
                />
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-1_${id})`}
                />
                <path
                ...
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-5_${id})`}
                />
                <path
                ...
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-6_${id})`}
                />
                <path
                ...
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-7_${id})`}
                />
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-8_${id})`}
                />
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-9_${id})`}
                />
                <path
                ...
                <path
                    ...
                    fill={`url(#lobe-icons-meta-fill-12_${id})`}
                />
            </g>
        </svg>
    );
